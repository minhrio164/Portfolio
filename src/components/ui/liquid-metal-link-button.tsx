...
type LiquidMetalLinkButtonProps = {
  href: string;
  label: string;
};
...
export function LiquidMetalLinkButton({
  ...
  useEffect(() => {
    const styleId = "shader-canvas-style-liquid-metal-link";
    if (!document.getElementById(styleId)) {
      const style = document.createElement("style");
      style.id = styleId;
      style.textContent = `
        .shader-container-liquid-metal-link canvas {
          width: 100% !important;
        ...
        @keyframes liquid-metal-link-ripple {
          0% {
        ...
        >
          ...
          >
            ...
            >
              <div
                ref={shaderRef}
                className="shader-container-liquid-metal-link"
                style={{
                  borderRadius: "100px",
                  overflow: "hidden",
                  position: "relative",
            ...
            {ripples.map((ripple) => (
              <span
                ...
                style={{
                  ...
                  pointerEvents: "none",
                  animation: "liquid-metal-link-ripple 0.6s ease-out",
                }}
              />
            ))}
          </a>
